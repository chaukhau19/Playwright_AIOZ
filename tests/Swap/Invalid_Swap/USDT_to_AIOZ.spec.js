...
//Dedicated functions
import { InvalidSwapPage } from "../../../pages/Swap/Invalid_Swap/USDT_to_AIOZ.js";
...
test("Swap AIOZ to STRK with expired transaction", async ({ wallet }) => {  
...
//BUG
test("Swap AIOZ to STRK with slippage too low", async ({ wallet }) => {  
...
//BUG
test("Swap AIOZ to STRK with slippage too high", async ({ wallet }) => {  
