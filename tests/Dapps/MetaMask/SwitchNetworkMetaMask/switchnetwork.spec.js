...
test("Switch Network Ethereum to AIOZ Testnet with MetaMask", async ({ wallet, page }) => {
  ...
  await expect(page.getByTestId('Ethereum-selector')).toBeVisible();
  await page.waitForTimeout(1000);
  await page.getByTestId('chain-selector').click();
  await page.waitForTimeout(1000);
  await page.getByTestId('AIOZ Testnet-selector').click();
  await expect(page.getByTestId('AIOZ Testnet-selector')).toBeVisible();
  await page.waitForTimeout(1000);
});
